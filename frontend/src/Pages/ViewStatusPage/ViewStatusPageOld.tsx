...
const ViewStatusPage = () => {
  ...
  if (userData) {
    ...
    // Handle the case where userData is null or missing, e.g., set a default value
    privilege = null;
  }
            ...
            <div className=" border-[#e6e6e6] rounded-md border-[1px] p-[16px] w-full flex  gap-[20px] flex-col lg:mt-0 mt-[30px] h-fit">
              ...
              <div className="border-[#e6e6e6]  border-[1px] p-[16px]  w-full flex  gap-[20px] flex-col lg:mt-0 mt-[30px] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div>
                  ...
                  {/* <h1
                    className="sm:text-[25px] text-[20px] font-extrabold leading-[16px] text-center"
                  ...
                  <div className="mt-[57px] sm:mr-[30px] mr-[5px]">
                    <ol className="relative left-[4%] pl-0 lg:max-w-[551px] md:max-w-[545px] sm:max-w-[400px] min-w-[800px]">
                      ...
                      >
                        ...
                        <div className="flex justify-between ">
                          ...
                          {/* {statusData?.submission_reviews.length !== 0 && (
                    <button
                      className="flex items-center gap-2 py-[3px]"
                      onClick={() => setShowComments(!showComments)}
                    >
                      <span>Comments</span>
                      {!showComments ? <FaChevronDown /> : <FaChevronUp />}
                    </button>
                  )} */}
                        ...
                        value={startDate}
                        className={
                          "sm:text-right sm:max-w-[150px] max-w-[100px] placeholder:text-[#000] md:text-[20px] text-[16px] font-normal leading-[24px] focus-visible:outline-none cursor-pointer"
                        }
                      /> */}
                        ...
                        <div className="flex flex-col">
                          ...
                          {/* {statusData.submission_reviews.length !== 0 ? (
                    <CommentFormList showAppID={showAppID} />
                  ) : (
                    <p className="bg-[#D9D9D9] rounded-[10px] text-[14px] font-normal leading-[17px] text-[#000] p-[15px_7px_15px_10px] mt-2 max-w-[330px] focus:outline-none"></p>
                          ...
                          {/*
                    {statusData?.submission_reviews.map((data, index) => (
                      <p
                        key={index}
                        className="bg-[#D9D9D9] rounded-[10px] text-[14px] font-normal leading-[17px] text-[#000] p-[6px_7px_6px_10px] max-w-[330px] focus:outline-none"
                      >
                        {data?.comment}
                      </p>
                    ))} */}
                  ...
                  Review Model
                      ...
                      placeholderText="MM/DD/YYYY"
                      className={
                        "sm:text-right sm:max-w-none max-w-[100px] placeholder:text-[#000] md:text-[20px] text-[16px] font-normal leading-[24px] focus-visible:outline-none cursor-pointer"
                      }
                    /> */}
                            {/* <div className="text-[#000] md:text-[20px] text-[16px] font-normal leading-[24px]">
                      {currTime} PST
                  ...
                  {/*
          <div className="mt-[39px] mb-[115px]">
            <h1 className="text-[25px] font-bold leading-[16px] text-center">
              Got any questions?
            </h1>
            <div className="flex flex-col max-w-[578px] m-auto">
              <label className="text-[17px] font-bold leading-[16px] mulish py-[13px]">
                Title
              </label>
              <input
                type="text"
                className="border-[1px] border-[#66666680] shadow-[0px_4px_4px_0px_#00000040] text-[#666666] text-[14px] font-normal p-[15px_12px] rounded-[10px] focus:outline-none"
              />
            </div>

            <div className="flex flex-col max-w-[578px] m-auto">
              <label
                className="text-[17px] font-bold leading-[16px] mulish py-[13px]"
                data-testid="Describe"
              >
                Please describe your question.
              </label>
              <textarea className="border-[1px] border-[#66666680] shadow-[0px_4px_4px_0px_#00000040] text-[#666666] text-[14px] font-normal p-[15px_12px] rounded-[10px] h-[143px] focus:outline-none"></textarea>
            </div>
            <div className="flex lg:justify-end justify-center items-end">
              <button className="bg-[#0A2239] p-[8px_32px] text-[#fff] text-[14px] leading-[16px] font-normal mulish rounded-[12px] mt-[36px]">
                Submit inquiry
              </button>
            </div>
          </div>
