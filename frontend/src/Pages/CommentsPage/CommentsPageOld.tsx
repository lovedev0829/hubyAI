      ...
      <div className="flex" data-testid="sidebar-toggle">
        ...
        <div className="w-full max-w-[1000px] md:!m-auto pt-[42px] pb-[46px] sm:ml-0 !ml-[-116px]  min-h-[84vh] h-full">
          ...
          <div className=" sm:mx-[20px]">
            ...
            {/* <div className="flex sm:gap-[17px] gap-[7px] items-center">
              <img src={user} alt="user-image" className="sm:w-auto w-[30px]" />
              <div className="flex items-center lg:gap-[88px] sm:gap-[20px] gap-[7px] border-b-[1px] border-b-[#000] sm:px-[17px] py-[13px]">
                <div className="">
                  <div>
                    <h6 className="sm:text-[16px] text-[12px] font-normal mulish sm:leading-[16px]">
                    ...
                    <p className="sm:text-[16px] text-[12px] font-normal mulish sm:leading-[16px]">
                      I think this app is really really really really
                      coooooooooooooooooool. I think this app is really really
                      really really coooooooooooooooooool
                    </p>
                  </div>
                  <div className="flex items-center lg:gap-[88px] sm:gap-[20px] gap-[10px]">
                    <div className="flex items-center mg:gap-[66px] sm:gap-[20px] gap-[6px]">
                      <h3 className="sm:text-[16px] text-[12px] font-bold sm:leading-[16px] m-0 mulish">
                        Reply
                      </h3>
                      ...
                      >
                        <div>
                          <Menu.Button className="inline-flex w-full justify-center items-center sm:text-[16px] text-[12px] font-bold sm:leading-[16px] mulish">
                            {selected} Replies
                            <RiArrowDropDownLine
                              className="-mr-1 h-5 w-5 text-[#33363F]"
                              aria-hidden="true"
